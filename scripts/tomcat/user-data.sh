...
Manager_Gui_Password="tomcat"

Manager_Gui_and_Script_User_Name="admin"
Manager_Gui_and_Script_Password="admin"

Manager_Script_User_Name="sadmin"
Manager_Script="sadmin"

Host_Manager_User="hadmin"
Host_Manager_User_Password="hadmin"
